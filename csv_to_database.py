"""Saving the excel/csv to database"""
import pandas as pd
import pyodbc
import os
...
# Global variable to store iteration count
iteration_count = 0
...
def process_files_in_folder():
    global iteration_count  # Access the global iteration count variable
    ...
    try:
        ...
        while True:
            ...
            # Update the label in tkinter interface
            count_label.config(text=f"Iteration Count: {iteration_count}")
...
if __name__ == "__main__":
    ...
    count_label = ttk.Label(frame, text=f"Iteration Count: {iteration_count}")
